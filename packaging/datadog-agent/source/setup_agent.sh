...
trap '{ kill $AGENT_PID; error_trap; exit 255; }' INT TERM
trap '{ kill $AGENT_PID; error_trap; exit; }' EXIT
...
# On errors and exit, stop calling error_trap and quit properly
